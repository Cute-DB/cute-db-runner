create table city(country varchar(200),name varchar(200),state varchar(200),map varchar(200));
create table hotel(city_id int4,name varchar(200),address varchar(200),zip varchar(8));
create table review(hotel_id int4, idx int4, check_in_date date, rating int4, trip_type int4, title varchar(200), details varchar(200));
